...
const mobileImages = {
  "images/01_innocence_img_1.webp": "images/01_innocence_img_1_tel.webp",
  "images/01_innocence_img_2.webp": "images/01_innocence_img_2_tel.webp",
  "images/01_innocence_img_3.webp": "images/01_innocence_img_3_tel.webp",
};
...
const colPhotoData = [
  ...
  {
    desktop: "images/03_obsession.webp",
    tablet: "images/03_obsession_tablette.webp",
    mobile: "images/03_obsession_tel.webp",
  },
];
...
window.addEventListener("load", () => {
  if (isMobileBreakpoint()) mainImg.src = "images/01_innocence_img_1_tel.webp";
  updateColPhotos();
});
...
const compoImages = [
  ...
  "images/composition_pigment_rose.webp",
...
const urls = ["02_power.html", "03_obsession.html"];
  ...
  function redraw(now) {
    ...
    segments.forEach((seg) => {
      ...
      for (let i = 1; i < seg.length; i++) {
        ...
        ctx.strokeStyle = `rgba(214,142,137,${a.toFixed(4)})`;
      ...
      if (aLast > 0.005) {
        ctx.beginPath();
        ctx.lineCap = "round";
        ctx.strokeStyle = `rgba(214,142,137,${aLast.toFixed(4)})`;
    ...
    if (hasDrawn && !isDrawing && points.filter((p) => !p.gap).length === 0) {
