...
const mobileImages = {
  "images/02_power_img_1.webp": "images/02_power_img_1_tel.webp",
  "images/02_power_img_2.webp": "images/02_power_img_2_tel.webp",
  "images/02_power_img_3.webp": "images/02_power_img_3_tel.webp",
};
...
window.addEventListener("load", () => {
  if (isMobileBreakpoint()) mainImg.src = "images/02_power_img_1_tel.webp";
  updateColPhotos();
});
...
const compoImages = [
  ...
  "images/composition_pigment_rouge.webp",
...
const urls = ["01_innocence.html", "03_obsession.html"];
  ...
  function redraw(now) {
    ...
    segments.forEach((seg) => {
      ...
      for (let i = 1; i < seg.length; i++) {
        ...
        ctx.strokeStyle = `rgba(196,1,10,${a.toFixed(4)})`;
      ...
      if (aLast > 0.005) {
        ctx.beginPath();
        ctx.lineCap = "round";
        ctx.strokeStyle = `rgba(196,1,10,${aLast.toFixed(4)})`;
